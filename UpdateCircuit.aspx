<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="UpdateCircuit.aspx.cs" Inherits="UpdateCircuit" %>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtCctid" ReadOnly="true" runat="server" Width="250" CssClass="field required" />
            ...
            <asp:Panel ID="panel4" runat="server" CssClass="contentPanel">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drpAAddLine1" ToolTip="Select Address Line 1" runat="server" AutoPostBack="true" Style="width: auto" OnSelectedIndexChanged="drpAAddLine1_SelectedIndexChanged" />
                            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <label><strong>Address Line 1:</strong></label></td>
                        <td>
                            <asp:DropDownList ID="drpBAddLine1" ToolTip="Select Address Line 1" runat="server" Style="width: auto" AutoPostBack="true" OnSelectedIndexChanged="drpBAddLine1_SelectedIndexChanged" />
                            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" runat="server" id="Button12" data-toggle="modal" value="Update" causesvalidation="true" class="cancel" data-target="#SubmitForm" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
    ...
    <div id="submit">
        <div id="SubmitForm" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <p>
                    Are you sure you want to update circuit identity
